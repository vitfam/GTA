    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content text-dark">
            <div class="modal-header">
                <h5 class="modal-title" id="buyNowLabel">MAKE THIS DEAL</h5>
            ...
            <div class="modal-body d-flex justify-content-between">
                <div class="left">
                    ...
                    <div>PRICE : <b class="text-success">₹ <?php echo $discount_price; ?></b></div>
                </div>
            ...
            <div class="modal-footer">
                <form action='./sale/_buy.php' method='POST' style='width: 100%;'>
